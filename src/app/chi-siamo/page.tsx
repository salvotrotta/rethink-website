    ...
    <>
      ...
      <section className="bg-[#0A0A0A] text-white py-20 px-4 sm:px-6">
        <div className="max-w-3xl mx-auto">
          <p className="text-[#4A90D9] text-sm font-semibold uppercase tracking-widest mb-4">Chi siamo</p>
      ...
      <section className="py-16 px-4 sm:px-6 bg-[#F9F9F7]">
        <div className="max-w-3xl mx-auto">
          ...
          <h3 className="text-lg font-bold mb-3 text-[#1C3564]">Chi siamo</h3>
          ...
          <h3 className="text-lg font-bold mb-3 text-[#1C3564]">Cosa vediamo</h3>
          <p className="text-[#4A4A4A] leading-relaxed mb-6">
          ...
          <h3 className="text-lg font-bold mb-3 text-[#1C3564]">Cosa vogliamo</h3>
          ...
          <h3 className="text-lg font-bold mb-3 text-[#1C3564]">Come lo facciamo</h3>
          <ul className="list-disc list-inside text-[#4A4A4A] space-y-1 mb-6 ml-4">
          ...
          <div className="border-l-4 border-[#1C3564] pl-6 py-2 my-8 bg-white rounded-r-lg">
          ...
          <h3 className="text-lg font-bold mb-3 text-[#1C3564]">Cosa non siamo</h3>
          <p className="text-[#4A4A4A] leading-relaxed mb-6">
          ...
          <blockquote className="bg-[#0A0A0A] text-white rounded-lg p-8 text-xl italic leading-relaxed" style={{ fontFamily: "Playfair Display, serif" }}>
      ...
      <section className="py-16 px-4 sm:px-6 bg-[#F9F9F7] text-center">
        ...
        <div className="flex gap-4 justify-center flex-wrap">
          <Link href="/unisciti" className="bg-[#1C3564] text-white px-6 py-3 rounded-md font-semibold hover:bg-[#243f7a] transition-colors">
            Unisciti a ReThink
          </Link>
          <Link href="/statuto" className="border border-[#1C3564] text-[#1C3564] px-6 py-3 rounded-md font-semibold hover:bg-[#1C3564] hover:text-white transition-colors">
            Leggi lo Statuto
          </Link>
        </div>
      </section>
