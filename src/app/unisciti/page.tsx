    ...
    <>
      <section className="bg-[#292929] text-white py-20 px-4 sm:px-6">
        <div className="max-w-3xl mx-auto">
          <p className="text-[#FFD957] text-sm font-semibold uppercase tracking-widest mb-4">Unisciti</p>
      ...
      <section className="py-16 px-4 sm:px-6 bg-[#F9F9F7]">
        <div className="max-w-3xl mx-auto">
          ...
          <Link href="/sedi" className="bg-[#292929] text-white px-6 py-3 rounded-md font-semibold hover:bg-[#111111] transition-colors inline-block">
            Trova la tua sede →
          </Link>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 bg-[#292929] text-white text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <a
            ...
            className="bg-white text-[#292929] px-8 py-3 rounded-md font-bold hover:bg-gray-100 transition-colors inline-block"
          >
            Scrivici una mail
          </a>
        </div>
