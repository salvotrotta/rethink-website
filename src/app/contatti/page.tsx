    ...
    <>
      <section className="bg-[#292929] text-white py-20 px-4 sm:px-6">
        <div className="max-w-3xl mx-auto">
          <p className="text-[#FFD957] text-sm font-semibold uppercase tracking-widest mb-4">Contatti</p>
          ...
          <div className="bg-white border border-[#EBEBEB] rounded-lg p-8 shadow-sm">
            ...
            <div className="space-y-4">
              <div>
                ...
                <a href="mailto:info@rethink-uni.it" className="text-[#292929] font-semibold hover:underline">
                  info@rethink-uni.it
                </a>
              </div>
              <div>
                <p className="text-xs font-semibold text-[#4A4A4A] uppercase tracking-wider mb-1">Instagram</p>
                <a href="https://www.instagram.com/ReThink_uni" target="_blank" rel="noopener noreferrer" className="text-[#292929] font-semibold hover:underline">
                  @ReThink_uni
                </a>
              </div>
              <div>
                <p className="text-xs font-semibold text-[#4A4A4A] uppercase tracking-wider mb-1">Tutti i link</p>
                <a href="https://linktr.ee/ReThink_uni" target="_blank" rel="noopener noreferrer" className="text-[#292929] font-semibold hover:underline">
            ...
            <div className="mt-8 space-y-3">
              <a
                ...
                className="block w-full bg-[#292929] text-white px-5 py-3 rounded-md font-semibold text-center hover:bg-[#111111] transition-colors text-sm"
              >
                Scrivici una mail
              </a>
              <a
                href="mailto:info@rethink-uni.it?subject=Voglio fondare ReThink nella mia università"
                className="block w-full border border-[#292929] text-[#292929] px-5 py-3 rounded-md font-semibold text-center hover:bg-[#292929] hover:text-white transition-colors text-sm"
              >
            ...
            <div className="space-y-3">
              {sediFondate.map((s) => (
                <a
                  ...
                  className="flex items-center justify-between p-3 border border-[#EBEBEB] rounded-lg hover:border-[#292929] transition-colors group"
                >
                  <div>
                    <p className="font-semibold text-sm group-hover:text-[#292929]">{s.nome}</p>
                    <p className="text-xs text-[#4A4A4A]">{s.citta}</p>
                  </div>
                  <span className="text-[#292929] text-xs font-semibold">Instagram →</span>
                </a>
              ))}
            </div>
            <p className="text-xs text-[#4A4A4A] mt-4">
              Non trovi la tua università?{" "}
              <a href="/unisciti" className="text-[#292929] hover:underline font-semibold">
