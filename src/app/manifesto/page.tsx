    ...
    <>
      <section className="bg-[#0A0A0A] text-white py-20 px-4 sm:px-6">
        <div className="max-w-3xl mx-auto">
          <p className="text-[#4A90D9] text-sm font-semibold uppercase tracking-widest mb-4">Documento fondativo</p>
      ...
      <section className="py-16 px-4 sm:px-6 bg-[#F9F9F7]">
        <div className="max-w-3xl mx-auto prose prose-lg max-w-none">
          ...
          <h2 style={{ fontFamily: "Playfair Display, serif" }} className="text-2xl font-bold text-[#0A0A0A] mb-4">Chi siamo</h2>
          ...
          <h2 style={{ fontFamily: "Playfair Display, serif" }} className="text-2xl font-bold text-[#0A0A0A] mb-4">Cosa vediamo</h2>
          <p className="text-[#4A4A4A] leading-relaxed mb-8">
          ...
          <h2 style={{ fontFamily: "Playfair Display, serif" }} className="text-2xl font-bold text-[#0A0A0A] mb-4">Cosa vogliamo</h2>
          ...
          <h2 style={{ fontFamily: "Playfair Display, serif" }} className="text-2xl font-bold text-[#0A0A0A] mb-4">Come lo facciamo</h2>
          <ul className="text-[#4A4A4A] space-y-2 mb-8 ml-4 list-disc list-inside">
          ...
          <h2 style={{ fontFamily: "Playfair Display, serif" }} className="text-2xl font-bold text-[#0A0A0A] mb-6">In cosa crediamo</h2>
          ...
          <h2 style={{ fontFamily: "Playfair Display, serif" }} className="text-2xl font-bold text-[#0A0A0A] mb-4">A chi si rivolge</h2>
          <p className="text-[#4A4A4A] leading-relaxed mb-4">
